...
title Yanban AI - Starting Teacher Site
...
echo.
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%LAUNCHER%" -Page teacher
...
if not "%RESULT%"=="0" (
  ...
  echo Teacher page has been opened in your browser.
